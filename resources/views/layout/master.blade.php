            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu bg-light m-0">
                        <a href="/jemput-sampah" class="dropdown-item @yield('jemput-active')">Jemput Sampah</a>
                        <a href="/harga" class="dropdown-item @yield('harga-active')">Harga Sampah</a>
                    </div>
                </div>
                <a href="/contact" class="nav-item nav-link @yield('contact-active')">Contact</a>
            </div>
            <a href="" class="btn btn-primary py-4 px-lg-4 rounded-0 d-none d-lg-block">Akun<i
