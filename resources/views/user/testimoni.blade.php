        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-5 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <a class="btn btn-primary py-3 px-4">See More</a>
                </div>
                <div class="col-lg-7 text-right wow fadeInUp" data-wow-delay="0.5s">
                    ...
                    <button class="testimonial-btn testimonial-btn-left" onclick="nextTestimonial()"
                        style="visibility: visible !important; opacity: 1 !important;">&lt;</button>
                    <button class="testimonial-btn testimonial-btn-right" onclick="nextTestimonial()"
                        style="visibility: visible !important; opacity: 1 !important;">&gt;</button>
